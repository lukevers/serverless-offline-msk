    ...
    ServerlessOfflineAwsMskPlugin.prototype.init = function () {
        ...
        var _loop_1 = function (name_1, fn) {
            ...
            mskEvents.forEach(function (event) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, this.connectAndListen(name_1, fn, event)];
            }); }); });
        };
        ...
        for (var _i = 0, _c = Object.entries(((_b = (_a = this.serverless) === null || _a === void 0 ? void 0 : _a.service) === null || _b === void 0 ? void 0 : _b.functions) || {}); _i < _c.length; _i++) {
            var _d = _c[_i], name_1 = _d[0], fn = _d[1];
            var state_1 = _loop_1(name_1, fn);
            if (state_1 === "break")
                break;
        }
    };
    ServerlessOfflineAwsMskPlugin.prototype.connectAndListen = function (fnName, fn, event) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        lambdaParams = { endpoint: 'http://localhost:3002' };
